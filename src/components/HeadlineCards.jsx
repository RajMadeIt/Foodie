        ...
        <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
            ...
            <div className='relative rounded-xl'>
                <div className='absolute w-full h-full bg-black/50 text-white rounded-xl'>
                    ...
                    <button className='absolute border-white bg-white text-black bottom-4 mx-2'>Order Now</button>
                </div>

                <img className='w-full object-cover rounded-xl max-h-[160px] md:max-h-[200px]' src='https://images.unsplash.com/photo-1613769049987-b31b641f25b1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjF8fGJyZWFrZmFzdHxlbnwwfDB8MHx8&auto=format&fit=crop&w=800&q=60' alt='/' />
            </div>
